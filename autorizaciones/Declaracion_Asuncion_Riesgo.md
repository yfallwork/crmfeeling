# Declaración de Asunción de Riesgo de la Actividad
...
## Datos del progenitor/tutor legal que firma

- Nombre y apellidos: _______________________________
- DNI/NIE: _______________________________
- Relación con la menor: _______________________________
...
- La menor se obliga a adaptar su conducción, esfuerzo físico y comportamiento a las indicaciones del personal técnico de la organización (CD Autoclub La Dehesa y Motorsport Ibérica) en todo momento durante el proceso.
...
**Firma del progenitor/tutor legal**
Nombre: _______________________________
Fecha: _______________________________
Firma: _______________________________

*(Si el documento se recoge de forma electrónica en el CRM, sustituir por checkbox de aceptación + registro de IP y timestamp, conforme al resto de documentos del proceso.)*
